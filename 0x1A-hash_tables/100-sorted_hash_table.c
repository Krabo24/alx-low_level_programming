...
/**
 * sorted_list - the function to insert new node in sorted list
...
/**
 * shash_table_create - create the sorted hash tables
...
/**
 * shash_table_set - function that adds an element to sorted hash table
 * @ht: pointer to the sorted hash table
 * @key: key to add element
 * @value: value to add element
 * Return: 1 if it successful and 0 Otherwise
 */
...
/**
 * shash_table_get - function to retrieve the value associeted with the key
 * @ht: pointer to the hash table
 * @key: the key to retrive the value
 * Return: the value or NULL if the key does not exit
 */
...
/**
 * shash_table_print - the function to print the key:value from ht
 * @ht: pointer to the hash table
 *
 */
...
/**
 * shash_table_print_rev - function to print key:value from ht in reverse
 * @ht: pointer to the hash table
 *
 */
...
/**
 * shash_table_delete - frees hash table and all the nodes
 * @ht: pointer to the hash table
 *
 */
